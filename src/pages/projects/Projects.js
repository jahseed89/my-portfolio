          ...
          <div className="projects-wrapper" onClick={closeModal}>
            <div className="first-proj">
              ...
              <div className="ibiliev-desc">
                ...
                <p>
                  This platform seeks to help propel talented individuals into
                  the world of fame. Are you good at singing, dancing or at any
                  cool thing? iBelieve is a platform where you can leverage on
                  your talents and become a global star.
                </p>
            ...
            <div className="second-proj-wrapper">
              <div className="second-proj">
                ...
                <p>
                  This Application accept any number A user input and convert it
                  to a roman figure
                </p>
                <div className="btn_holder">
                  <Links
              ...
              <div className="third-proj">
                ...
                <p>
                  This project was created when there was no room for workflow.
                  So I decided to come up with a dies game of fun. Playing
                  programaticaly
                </p>
                <div className="btn_holder">
                  <Links
            ...
            <div className="fourth-proj-wrapper">
              <div className="fith-proj-holder">
                ...
                <p>
                  ...
                  input that takes in any phone number and provides the righ
                  network information.
                </p>
                <div className="btn_holder">
                  <Links
